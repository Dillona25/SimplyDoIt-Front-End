...
const Profile = ({
  ...
  return (
    <profile className="px-[30px] flex flex-col justify-center h-screen">
      <div>
        <h1 className="font-[Poppins] font-semibold text-[30px] text-center mt-[25px]">
          Your Profile
        </h1>
        <img
          className=" bg-center h-[180px] w-[180px] self-center rounded-[50%] mt-[30px] m-auto"
        ...
        >
          ...
          ></input>
          <label className="font-[Poppins] mt-[10px]">
